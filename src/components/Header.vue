<template>
  <div class="header">
    <div class="header-content">
      ...
      <nav>
        <div class="home active"><span class="lnr lnr-home"></span></div>
        <div class="events"><span class="lnr lnr-calendar-full"></span></div>
        <div class="profile">
